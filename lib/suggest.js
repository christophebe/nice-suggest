...
function giveMeKwSuggestions(kwInfo, config, callback) {
    ...
    //log.info("Find suggestionf for " + kwInfo.keyword + "  - deep : " + kwInfo.deep);
    var requestConfig = config.proxyList ? {'proxy': config.proxyList.getProxy().getUrl()} : {};
    console.log(requestConfig)
  	var r = request.defaults(requestConfig);
